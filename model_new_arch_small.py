...
base_lr = 3e-3
optimizer = raw_model.configure_optimizer(weight_decay=0.05, learning_rate=base_lr, device=device)
...
for step in range(max_steps):
    ...
    if step % 1000 == 0 and master_process and step > 0:
        save_checkpoint(
            ...
            log_dir="./checkpoints_small"
        )
        upload_folder_to_s3(local_folder_path="./checkpoints_small", bucket_name="dataframes--use1-az6--x-s3",
                            s3_prefix="training_new_arch/log/small")
