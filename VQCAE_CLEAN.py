...
def main():
    ...
    parser.add_argument("--min_lr", type=float, default=4e-3, help="Final learning rate")
    ...
    model = VQCAE(in_channels=in_channels, hidden_channels=16*4096, codebook_size=128).to(args.device)
