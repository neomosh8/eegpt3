...
class VQCAE(nn.Module):
    def __init__(self, in_channels=3, hidden_channels=128, codebook_size=128, decay=0.8, commitment_beta=0.15):
        super().__init__()
...
def main():
    ...
    model = VQCAE(in_channels=in_channels, hidden_channels=1024, codebook_size=1024).to(args.device)
