...
def main():
    ...
    parser.add_argument("--min_lr", type=float, default=4e-6, help="Final learning rate")
    ...
    model = VQCAE(in_channels=in_channels, hidden_channels=6*4096, codebook_size=128).to(args.device)
