...
class VectorQuantizerEMA(nn.Module):
    def __init__(self, codebook_size, embedding_dim, decay=0.95, eps=1e-5):
        super().__init__()
...
class VQCAE(nn.Module):
    def __init__(self, in_channels=3, hidden_channels=128, codebook_size=128, decay=0.95, commitment_beta=0.0):
        super().__init__()
...
def main():
    ...
    parser.add_argument("--min_lr", type=float, default=1e-3, help="Final learning rate")
